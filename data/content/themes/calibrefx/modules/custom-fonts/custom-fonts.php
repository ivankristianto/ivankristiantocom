...
$fonts = apply_filters( 'calibrefx_webfont', array(
	'Abel' => array('font-family' => '"Abel", sans-serif;',
			'google-font' => true,
			'google-font-style' => '400,700',
			),
	'Arial' => array('font-family' => 'Arial, Helvetica, sans-serif;',
			'google-font' => false,
			),
	'Calibri' => array('font-family' => 'Calibri, Candara, Segoe, "Segoe UI", Optima, Arial, sans-serif;',
			'google-font' => false,
			),
	'Droid Sans' => array('font-family' => '"Droid Sans", sans-serif;',
			'google-font' => true,
			'google-font-style' => '400,700',
			),
	'Droid Serif' => array('font-family' => '"Droid Serif", Georgia, "Times New Roman", sans-serif;',
			'google-font' => true,
			'google-font-style' => '400,700',
			),
	'Georgia' => array('font-family' => 'Georgia, "Times New Roman", Times, serif;',
			'google-font' => false,
			),
	'Grand Hotel' => array('font-family' => '"Grand Hotel", cursive',
			'google-font' => true,
			'google-font-style' => '400,700',
			),
	'Helvetica' => array('font-family' => 'Helvetica, Arial, sans-serif;',
			'google-font' => false,
			),
	'Istok Web' => array('font-family' => '"Istok Web", sans-serif',
			'google-font' => true,
			'google-font-style' => '400,700',
			),
	'Lato' => array('font-family' => '"Lato", sans-serif;',
			'google-font' => true,
			'google-font-style' => '400,700',
			),
	'Lora' => array('font-family' => '"Lora", serif',
			'google-font' => true,
			'google-font-style' => '400,700',
			),
	'Montserrat' => array('font-family' => '"Montserrat", sans-serif',
			'google-font' => true,
			'google-font-style' => '400,700',
			),
	'Noticia Text' => array('font-family' => '"Noticia Text", serif;',
			'google-font' => true,
			'google-font-style' => '400,700',
			),
	'Noto Sans' => array('font-family' => '"Noto Sans", sans-serif',
			'google-font' => true,
			'google-font-style' => '400,700',
			),
	'Noto Serif' => array('font-family' => '"Noto Serif", serif',
			'google-font' => true,
			'google-font-style' => '400,700',
			),
	'Open Sans' => array('font-family' => '"Open Sans", Verdana, Geneva, sans-serif;',
			'google-font' => true,
			'google-font-style' => '400,600,700',
			),
	'Palatino Linotype' => array('font-family' => '"Palatino Linotype", "Book Antiqua", Palatino, serif;',
			'google-font' => true,
			'google-font-style' => '400,700',
			),
	'PT Sans Caption' => array('font-family' => '"PT Sans Caption", sans-serif;',
			'google-font' => true,
			'google-font-style' => '400,700',
			),
	'PT Sans' => array('font-family' => '"PT Sans", sans-serif;',
			'google-font' => true,
			'google-font-style' => '400,700',
			),
	'PT Serif' => array('font-family' => '"PT Serif", sans-serif;',
			'google-font' => true,
			'google-font-style' => '400,700',
			),
	'Raleway' => array('font-family' => '"Raleway", sans-serif;',
			'google-font' => true,
			'google-font-style' => '400,700',
			),
	'Roboto Slab' => array('font-family' => '"Roboto Slab", sans-serif',
			'google-font' => true,
			'google-font-style' => '400,700',
			),
	'Roboto' => array('font-family' => '"Roboto", sans-serif',
			'google-font' => true,
			'google-font-style' => '400,700',
			),
	'Signika Negative' => array('font-family' => '"Signika Negative", sans-serif',
			'google-font' => true,
			'google-font-style' => '400,700',
			),
	'Signika' => array('font-family' => '"Signika", sans-serif',
			'google-font' => true,
			'google-font-style' => '400,700',
			),
	'Source Sans Pro' => array('font-family' => '"Source Sans Pro", sans-serif',
			'google-font' => true,
			'google-font-style' => '400,700',
			),
	'Tahoma' => array('font-family' => 'Tahoma, Geneva, sans-serif;',
			'google-font' => false,
			),
	'Times' => array('font-family' => '"Times New Roman", Times, serif;',
			'google-font' => false,
			),
	'Titillium Web' => array('font-family' => '"Titillium Web", sans-serif',
			'google-font' => true,
			'google-font-style' => '400,600,700',
			),
	'Trebuchet' => array('font-family' => '"Trebuchet MS", Arial, Helvetica, sans-serif;',
			'google-font' => false,
			),
	'Ubuntu Mono' => array('font-family' => '"Ubuntu Mono", sans-serif',
			'google-font' => true,
			'google-font-style' => '400,700',
			),
	'Ubuntu' => array('font-family' => '"Ubuntu", sans-serif;',
			'google-font' => true,
			'google-font-style' => '400,700',
			),
...
function webfont_load_fonts() {
	...
	if ( $font_loaded ) {
		echo '<link rel="stylesheet" type="text/css" href="//fonts.googleapis.com/css?family=' . $font_loaded . '" media="screen">'; }
}
